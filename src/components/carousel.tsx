...
const reviews = [
  {
    name: 'ООО "НВС Групп"',
    description:
      "Турникеты PERCO, шлагбаум CAME, Контроль доступа на оборудовании БОЛИД, " +
      "Структурированная кабельная сеть, Серверное оборудование на базе Элтекс, " +
      "РАСЦО на базе УКБ СГС-22-МЕ 600, Проводное радиовещание на основе оборудования РТС-2000",
    image: { Img01 }.Img01,
  ...
  },
  {
    name: 'ООО "Мы рядом"',
    description:
      "Серверное оборудование на базе MikroTik, Cтруктурированная кабельная сеть, " +
  ...
  },
  {
    ...
    description:
      "Серверное оборудование на базе ZyXEL, Cтруктурированная кабельная сеть, " +
      "Цифровое и аналоговое видеонаблюдение на базе оборудования Dahua Technology и RVI",
    image: { Img03 }.Img03,
        ...
        <div key={item.name}>
          <div className="relative h-full w-full">
            <Image
              src={item.image}
              alt={item.alt}
              className="rounded-3xl max-h-[38rem]"
            ></Image>
